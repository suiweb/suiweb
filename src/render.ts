 ...
 * and compare the newly generated fiber tree with the old one, and then applies all
 * changes to the DOM.
...
export function rerenderFunctionalFiber(fiber: FunctionalFiber, container: HTMLElement) {
    ...
    // When rendering, the functional fiber will recompute all its children with the fiberFunction.
...
function unwrapFunctionalFiber(fiber: FunctionalFiber, container: HTMLElement, previousVersion?: Fiber) {
    ...
    prepareToUseHooks(fiber, container)
